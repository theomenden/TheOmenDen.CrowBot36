...
using TheOmenDen.Crowbot36.UI.Server.Twitch.Channels;
using TheOmenDen.Crowbot36.UI.Shared.Models.Twitch;
using TheOmenDen.Shared.Guards;
using TheOmenDen.Crowbot36.UI.Shared.Services;

namespace TheOmenDen.Crowbot36.UI.Server.Twitch.Services;

internal sealed class TwitchChatService: IDisposable, IAsyncDisposable
{
